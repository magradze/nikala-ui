...
interface ComponentPreviewProps {
  ...
  code: string;               // component's TSX example code
  children: JSX.Element;      // live component render
  ...
  return (
    <div class="group relative my-4 flex flex-col space-y-2">
      <Tabs defaultValue="preview" class="relative mr-auto w-full">
        ...
        {/* Live Preview Tab */}
        <TabsContent value="preview" class="relative rounded-lg border border-border bg-background/50 p-10 backdrop-blur-sm">
