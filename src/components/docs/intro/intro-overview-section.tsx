...
export function IntroOverviewSection() {
  return (
    <div class="space-y-4">
      ...
      <p class="text-sm sm:text-base text-muted-foreground leading-relaxed">
        Nikala UI is architected as a modern monorepo separating the command-line client (<code class="bg-muted px-1.5 py-0.5 rounded text-xs font-mono">@nikala-ui/cli</code>) from the core design system (<code class="bg-muted px-1.5 py-0.5 rounded text-xs font-mono">@nikala-ui/core</code>), allowing background registry updates without requiring CLI package updates.
      </p>
    </div>
  );
}