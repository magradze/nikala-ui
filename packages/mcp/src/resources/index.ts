...
1. Tailwind v4 Tokens: Use semantic tokens like bg-background, text-foreground, bg-card, border-border, bg-primary from @import "tailwindcss".
...
export const RESOURCE_LIST = [
  ...
  },
  {
    ...
    description: "Semantic color tokens and anti-FOUC ThemeScript usage",
    mimeType: "text/plain",
  },
];
